...
------------------------------------------------------------------------------
SGLang also supports running verl's RAY-based cross-machine inference in IPv4 and IPv6 scenarios. In the script below, we use TP=16 for cross-machine inference. Suppose we have two interconnected machines: node0 with IP 192.0.2.20 and node1 with IP 192.0.2.21.
...
.. code-block:: bash
    ...
    To add another node to this Ray cluster, run
        ray start --address='192.0.2.20:6379'
