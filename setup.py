...
with open(os.path.join(version_folder, "agent_system/taspo/version.txt")) as f:
...
setup(
    ...
    packages=find_namespace_packages(
        where=".",
        include=["agent_system*", "verl*"],
        exclude=["tests*", "examples*", "docs*", "recipe*"],
    ),
    license="Apache 2.0",
    description="TASPO: trajectory-aligned process supervision for agentic reinforcement learning",
